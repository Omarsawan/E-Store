...
describe('Order Model', () => {
  beforeAll(async function () {
    ...
    const sql =
      'DELETE FROM order_products; ALTER SEQUENCE order_products_id_seq RESTART; DELETE FROM orders; ALTER SEQUENCE orders_id_seq RESTART; DELETE FROM products; ALTER SEQUENCE products_id_seq RESTART; DELETE FROM users; ALTER SEQUENCE users_id_seq RESTART;';
...
describe('Order endpoints', () => {
  ...
  beforeAll(async function () {
    const connection = await database_1.default.connect();
    const sql =
      'DELETE FROM order_products; ALTER SEQUENCE order_products_id_seq RESTART; DELETE FROM orders; ALTER SEQUENCE orders_id_seq RESTART; DELETE FROM users; ALTER SEQUENCE users_id_seq RESTART;';
    await connection.query(sql);
    connection.release();
    // @ts-ignore
