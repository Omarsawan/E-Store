...
var activeOrder = function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    var user_id, order, err_1;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          _a.trys.push([0, 2, , 3]);
          user_id = (0, auth_1.getUserIdFromToken)(req, res);
          return [4 /*yield*/, store.activeOrder(user_id)];
        case 1:
          order = _a.sent();
          res.json(order);
          return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            store.create((0, auth_1.getUserIdFromToken)(req, res))
          ];
        case 1:
          neworder = _a.sent();
          res.json(neworder);
