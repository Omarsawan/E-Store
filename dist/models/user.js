...
var _a = process.env,
  BCRYPT_PASSWORD = _a.BCRYPT_PASSWORD,
  SALT_ROUNDS = _a.SALT_ROUNDS;
var UserStore = /** @class */ (function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              conn.query(sql, [b.first_name, b.last_name, hash])
            ];
          case 2:
            result = _a.sent();
            user = result.rows[0];
  ...
  UserStore.prototype.authenticate = function (
    first_name,
    last_name,
    password
  ) {
